...
const ForgotPassword = () => {
    return (
        <body className="register page-login">
                                ...
                                <div className="col-lg-12">
                                    <div className="single-form-s-wrapper">
                                        <div className="head">
                                            ...
                                            {/* <h5 className="title">Strong passwords include numbers, letters, and punctuation marks.</h5> */}
                                        </div>
                                        <div className="body">
                                            <form action="#" method="post">
                                                ...
                                                <p><a className="ml--5" href="/login">Back To Login</a></p>
                                            </form>
                                        </div>
